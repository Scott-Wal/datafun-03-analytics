...
def fetch_txt_file(folder_name: str, filename: str, url: str) -> None:
    ...
    Example:
        fetch_txt_file("data", "baseball.txt", "https://github.com/UCIDataScienceInitiative/PredictiveModeling_withPython/blob/master/data/baseball.txt")
    """
    if not url:
...
def main():
    ...
    """
    txt_url = 'https://github.com/UCIDataScienceInitiative/PredictiveModeling_withPython/blob/master/data/baseball.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(fetched_folder_name, "baseball.txt", txt_url)
