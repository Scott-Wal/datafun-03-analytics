...
def process_text_file():
    """Read a text file, count occurrences of 'baseball', and save the result."""
    input_file = pathlib.Path(data, "baseball.txt")
    output_file = pathlib.Path(data_processed, "text_baseball_word_count.txt")
    word_to_count: str = "baseball"
