...
def fetch_csv_file(folder_name: str, filename: str, url: str) -> None:
    ...
    Example:
        fetch_csv_file("baseball", "baseball.csv", "https://github.com/pandas-dev/pandas/blob/main/doc/data/baseball.csv")
    """
    if not url:
...
def main():
    ...
    """
    csv_url = 'https://github.com/pandas-dev/pandas/blob/main/doc/data/baseball.csv'
    logger.info("Starting CSV fetch demonstration...")
    fetch_csv_file(fetched_folder_name, "baseball.csv", csv_url)
